...
class Exams12Controller extends AppController
{
    ...
    public function initialize()
    {
        ...
        $this->loadComponent('Exam12');

        $this->D_BAJ3_RESULT = Configure::read("D_BAJ3_RESULT");
        ...
        //テスト詳細データ取得
        $this->ttp= $this->Exam12->__getTestDataDetail();
    ...
    public function __getTestData($id){
        ...
        if($this->request->getData('next')){
            ...
            if($finflag){
                ...
                header("Location:/exams12/fin/".$id);
                exit();
        ...
        if($this->request->getData('back')){
            ...
            if($pager < 1){
                header("Location:/exams12/guide/".$id);
                exit();
            }
        }
    ...
    public function fin($id){
        ...
        //テスト結果の取得
        $soyo = $this->ttp->soyo;
        $result['text0'] = $this->D_BAJ3_RESULT[$soyo][0];
        $result['text1'] = $this->D_BAJ3_RESULT[$soyo][1];
        $result['text2'] = $this->D_BAJ3_RESULT[$soyo][2];
        $result['text3'] = $this->D_BAJ3_RESULT[$soyo][3];
        $result['text4'] = $this->D_BAJ3_RESULT[$soyo][4];
